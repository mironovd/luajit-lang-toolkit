...
#include "lang/ast_boolean_const_eval.h"
#include "lang/ast_const_eval.h"
...
#include "lang/id_generator.h"
#include "lang/lua_ast.h"
...
static struct bcpair bcmodule[] = {
    {"ast_boolean_const_eval", luaJIT_BC_ast_boolean_const_eval, luaJIT_BC_ast_boolean_const_eval_SIZE},
    {"ast_const_eval", luaJIT_BC_ast_const_eval, luaJIT_BC_ast_const_eval_SIZE},
    ...
    {"id_generator", luaJIT_BC_id_generator, luaJIT_BC_id_generator_SIZE},
    {"lua_ast", luaJIT_BC_lua_ast, luaJIT_BC_lua_ast_SIZE},
